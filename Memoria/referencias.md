# Referencias — RAGMED (formato IEEE)

Las siguientes referencias se listan en el orden en que aparecen citadas en el documento.
Copiar al final de `memoria.md` al completar todas las secciones.
